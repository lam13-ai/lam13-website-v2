...
// ----------------------------------------------------------------------
// Adapted for this Vite + Tailwind 3 project: "use client" removed and the
// external (cloudinary) model icons replaced with a local neutral glyph so
// the component ships no third-party requests.
// ----------------------------------------------------------------------
...
function ModelIcon({ className }: { model?: string; className?: string }) {
  return (
    <span
      aria-hidden="true"
      className={cn("inline-block size-3.5 shrink-0 [background:var(--gradient-accent)]", className)}
    />
  );
}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "animate-in fade-in slide-in-from-top-3 zoom-in-90"
      )}
...
function AttachmentGalleryModal({
  ...
  return (
    <div className="fixed inset-0 z-[100]" onClick={handleClose} role="dialog" aria-modal="true">
      <div className="absolute inset-0 bg-background/70 backdrop-blur-md transition-opacity" style={{ opacity: isOpen ? 1 : 0 }} />
      <div
        style={{
          position: "fixed",
...
export interface PromptInputProps {
  ...
  /** max-width when collapsed / expanded (px) */
          ...
          >
            <style
              dangerouslySetInnerHTML={{
                __html:
                  ".prompt-scrollbar::-webkit-scrollbar { width: 4px; height: 4px; background: transparent; } .prompt-scrollbar::-webkit-scrollbar-track { background: transparent; } .prompt-scrollbar::-webkit-scrollbar-thumb { background: transparent; border-radius: 4px; } .prompt-scrollbar:hover::-webkit-scrollbar-thumb { background: hsl(var(--muted-foreground) / 0.3); }",
              }}
            />
            ...
            <textarea
              ...
              className={cn(
                "prompt-scrollbar absolute top-0 inset-x-0 z-[1] w-full resize-none bg-transparent pl-4 pr-12 py-3.5 text-base sm:text-sm leading-[22px] text-foreground outline-none placeholder:font-medium placeholder:text-muted-foreground/80 cursor-text",
            ...
            <button
              ...
              className={cn(
                "absolute inset-x-0 top-0 z-[1] cursor-text truncate pl-4 pr-12 py-[15px] text-left text-base sm:text-sm font-medium leading-[17px] text-muted-foreground/80 outline-none",
            ...
            >
              <div className="relative">
                <button
                  ...
                  className={cn(
                    "group flex items-center gap-1 rounded-full px-2 py-1 text-foreground/50 transition-all duration-200 outline-none hover:bg-accent/10 hover:text-foreground cursor-default",
                    isModelSelectOpen ? "bg-accent/10 text-foreground" : ""
                  )}
                ...
                <div
                  ...
                  className={cn(
                    "absolute bottom-full left-0 mb-2.5 z-50 w-44 rounded-2xl border border-border bg-card/95 p-1 shadow-xl backdrop-blur-md flex flex-col gap-0.5 transition-all cursor-default",
                    isModelSelectOpen
                ...
                >
                  <div className="relative flex flex-col gap-0.5">
                    <div style={hoverStyle} className="absolute left-0 right-0 top-0 h-8 -z-10 rounded-xl bg-muted pointer-events-none" />
              ...
              <button
                ...
                onMouseDown={(e) => e.preventDefault()}
                onClick={cycleEffort}
                className="group flex items-center gap-1 rounded-full px-2 py-1 text-foreground/50 transition-all duration-200 hover:bg-accent/10 hover:text-foreground outline-none cursor-default"
              >
              ...
              <button
                ...
                className="ml-auto flex size-7 items-center justify-center rounded-full text-foreground/50 transition-all duration-200 hover:bg-accent/10 hover:text-foreground outline-none cursor-default disabled:opacity-40 disabled:pointer-events-none"
              >
                <PlusIcon />
              </button>
            </div>
